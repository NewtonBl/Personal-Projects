...
#Filter the tibble to eliminate "words" containing or consisting of numbers
...
excluded_words <- c("a", "year", "requires", "provide", "school", "the", "and",
                    "to", "of", "in", "with", "or", "for", "experience", "work",
                    "you", "as", "is", "on", "required", "skills", "team",
                    "ability", "will", "be", "including", "are", "have", "this",
                    "at", "that", "knowledge", "environment", "support", "working",
                    "by", "our", "position", "time", "all", "an", "duties", "other",
                    "must", "control", "include", "level", "degree", "maintain",
                    "perform", "performing", "performs", "we", "job", "qualifications",
                    "related", "variety", "years", "basic", "new", "training", "using",
                    "within", "your", "e.g", "education", "health", "next", "not",
                    "equivalent", "etc", "general", "if", "may", "participate",
                    "preferred", "project", "responsibilities", "staff", "able",
                    "full", "minimum", "practices", "role", "well", "but", "center",
                    "community", "from", "requirements")

#Count words and filter out the excluded words
